...
</div> : <div className="w-full text-center flex items-center justify-center -mt-24 text-xl "><div className="w-1/2 space-y-5 scroll-mt-60  transition ease-in-out delay-150  duration-300" id="Note_section">
