...
export default function AboutUs() {
  ...
  return (
    <div className=" min-w-full   md:flex md:text-3xl md:pt-[7rem] bg-gradient-to-br scroll-smooth from-indigo-600 to-indigo-300 md:px-52  md:scroll-my-52" >


      <div className="md:w-full  md:mr-14 flex flex-col items-center w-full justify-center md:flex-row md:items-start" >
        <div className=" md:inline-block w-fit scale-75 md:scale-125 md:p-2 bg-yellow-300 md:h-fit rounded-full">
      ...
      <div className="flex min-h-screen  items-center justify-center text-center md:text-left flex-col space-y-5 snap-y snap-mandatory">
        ...
        <div className="w-full h-screen space-y-5 p-5 snap-center snap-always md:scroll-mt-[15rem] scroll-mt-[5rem] md:hover:scale-125 transition ease-in-out delay-150 md:hover:-translate-y-1   duration-300" id="Project_Details_Section">
