...
export default function AboutUs() {
  return (
  <div className=" w-full h-screen md:flex md:text-3xl md:pt-64 bg-gradient-to-br  from-indigo-600 to-indigo-300 md:px-52 scroll-smooth md:scroll-my-52" >


<div className="md:w-full md:mr-5 flex flex-col items-center w-full justify-center" >
  <div className=" md:inline-block w-fit scale-75 md:p-2 bg-yellow-300 md:h-fit md:w-full rounded-full">
...
<div className="flex items-center justify-center text-center flex-col space-y-5 snap-y snap-mandatory">
...
<div className="w-full h-screen md:space-y-5 space-y-2 snap-center snap-always ">
  ...
  <div  className="md:text-lg text-base p-5 text-white w-full relative inline-flex">
  ...
  <div className="md:mt-20 w-full md:flex flex-col md:space-x-2 space-y-3  md:items-center md:justify-evenly">
...
<div className="w-full h-screen space-y-5 snap-center snap-always scroll-mt-80 hover:scale-125 transition ease-in-out delay-150 hover:-translate-y-1   duration-300" id="contact_section">
  <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-indigo-300 md:text-9xl text-6xl font-bold underline underline-offset-1">Contact</span>
